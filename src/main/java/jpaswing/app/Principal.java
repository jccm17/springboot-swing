...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton3 = new javax.swing.JButton(Utiles.cambiarIcono(FontAwesome.FLOPPY_O, Color.GREEN, 16));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        trabajador.setNombre( nombre.isEmpty() ? null : nombre );
        trabajador.setApellidos( apellidos.isEmpty() ? null : apellidos );
        trabajador.setDni( dni.isEmpty() ? null : dni );
