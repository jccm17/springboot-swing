...
public class TrabajadorServicio {
    ...
    public void llenarTabla(JTable tabla) {
        ...
        String[] cabecera = {"Id", "Nombre", "Apellidos", "CI", "", ""};
        ...
        for (Trabajador trabajador : lista) {
            ...
            JButton modificar = new JButton(Utiles.cambiarIcono(FontAwesome.PENCIL, Color.YELLOW, 16));
            JButton eliminar = new JButton(Utiles.cambiarIcono(FontAwesome.TRASH, Color.RED, 16));
